...
%type <ast> implements_list interface_extends_list case_list if_stmt_without_else_wunoth if_stmt_without_else
...
if_stmt_without_else_wunoth:
		 '(' expr ')'  T_IF statement
			{ 
	$$ = zend_ast_create_list(1, ZEND_AST_IF,zend_ast_create(ZEND_AST_IF_ELEM, $2, $5)); }
;

if_stmt_without_else:
	if_stmt_without_else_wunoth {  $$=$1;}
	| T_IF '(' expr ')' statement
			{ 
	$$ = zend_ast_create_list(1, ZEND_AST_IF,zend_ast_create(ZEND_AST_IF_ELEM, $3, $5)); }
...
if_stmt:
		if_stmt_without_else { printf("If 1222\n"); $$ = $1; }
...
alt_if_stmt:
		alt_if_stmt_without_else T_ENDIF ';' { printf("555\n");  $$ = $1; }
